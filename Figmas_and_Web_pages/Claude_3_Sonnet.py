...
def find_differences(png1, png2, prompt):
    ...
    runtime = boto3.client("bedrock-runtime", region_name='us-west-2', aws_access_key_id='AKIAYW3T4ZREPBJNJ2TQ', 
                           aws_secret_access_key='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')
